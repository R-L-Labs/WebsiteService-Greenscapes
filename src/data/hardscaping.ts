...
export const services = {
  ...
  description:
    'From elegant patios to structural retaining walls, we build hardscape features that add beauty, function, and value to your property.',
  items: [
    {
...
export const about = {
  ...
  accentStat: { value: '200+', label: 'Projects Completed' },
};

export const projects = {
  subtitle: 'Our Work',
  title: 'Featured Hardscaping Projects',
  description:
    'Browse our portfolio of hardscaping projects. Each one demonstrates our commitment to quality materials and expert craftsmanship.',
  items: [
    {
...
export const testimonials = {
  ...
  description:
    "See what homeowners and property owners have to say about our hardscaping work.",
  items: [
    {
      name: 'Robert Johnson',
      initials: 'RJ',
      role: 'Homeowner',
      quote:
        'The patio and fire pit Greenscapes built for us is incredible. The stonework is flawless and it has become the centerpiece of our backyard. Worth every penny.',
    },
    {
      name: 'David Chen',
      initials: 'DC',
      ...
      quote:
        'They built retaining walls on our commercial property that solved our drainage issues while looking fantastic. Professional crew and excellent project management.',
    },
    {
      name: 'Lisa Nguyen',
      initials: 'LN',
      role: 'Homeowner',
      quote:
        'Our new walkway and patio are beautiful. The team was meticulous about every detail, from the base preparation to the final sealing. Highly recommend their hardscaping work.',
    },
  ],
};
