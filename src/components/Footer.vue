    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2.5">
            <li>
              <a href="tel:+18564725751" class="text-text-muted hover:text-primary text-sm transition-colors">
                856-472-5751
              </a>
            </li>
            <li>
      ...
      <div class="border-t border-border mt-10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p class="text-text-muted text-sm">
          Copyright &copy; {{ new Date().getFullYear() }} Greenscapes - All Rights Reserved.
        </p>
...
const socials = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/105938601687540',
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/greenscapesconstruction/',
